...
<script>
  ...
  inputFile.addEventListener('change', function() {
    if(inputFile.value) {
      fileName.classList.add('bg-green-700');
      fileName.innerHTML = `
      <p class="font-semibold">${inputFile.value}</p>
      `;

    } else {
      fileName.classList.remove('bg-green-700');
